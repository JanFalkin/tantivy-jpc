    ...
    pub fn handle_query_parser(
        ...
        match method {
            ...
            "parse_query" => {
                ...
                // REVIEW: Should this be uncommented? Or removed?
            ...
            "parse_fuzzy_query" => {
                ...
                // REVIEW: Nit: same thing with these double ok-or-else patterns, look at how I did
                // it for request_fields under for_index to see an example
                let request_field = m
                    .get("field")
